...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Register -->
      <li class="nav-item">
        <a class="nav-link" href="pypi/register.php">
          <i class="fas fa-fw fa-table"></i>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <h4 class="small font-weight-bold">PyPI<span class="float-right">80% Testing!</span></h4>
                  <div class="progress mb-4">
                    <div class="progress-bar bg-info" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <h4 class="small font-weight-bold">POP3 and SMTP<span class="float-right">Complete!</span></h4>
                  <div class="progress">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Project Update</h6>
                </div>
                <div class="card-body">
                  <p>The project teams have been formed and work allocated. Please check your emails for further instructions and register an account</p>
                </div>
              </div>
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">PyPI</h6>
                </div>
                <div class="card-body">
                  <p>It is now possible to install modules with pip on our servers</p>
                  <hr>
                  <img src="/img/registration.png" width="50%" height="50%"/>
                </div>
              </div>
