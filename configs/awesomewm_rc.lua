...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Left", function () awful.client. 
        swap.byidx( -1)    end,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "f",
        ...
        {description = "Toggle horizontal maximization", group = "client"}),
    awful.key({ modkey,  }, "v",
        function (c)
            c.maximized_vertical = not c.maximized_vertical
            c:raise()
        end ,
        {description = "Toggle vertical maximization", group = "client"})
)
...
for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, "Control" }, "#" .. i + 9,
                  ...
                  {description = "Mirror focused client on tag #" .. i, group = "tag"})
    )
end
